...
| 이주희 | C++ 백엔드 서버, TCP 서버 및 데이터베이스 관리 시스템 개발 |
| 팀원1 | 블루투스 통신 |
| 팀원2 | 데이터베이스 관리 시스템 개발 |

### 안전/보안
| 이름 | 담당 업무 |
|------|----------|
| 팀원3 | 보안/화재 감지 시스템 구현 및 창문 장치 개발 |
| 팀원4 | 인증/등록 관리 시스템 구현 및 도어락, 창문 장치 개발 |

### 반려동물
| 이름 | 담당 업무 |
|------|----------|
| 팀원5 | 카메라와 초음파센서를 이용한 반려동물 인식 및 배변 감지 시스템 개발, 급수/급식기 디자인 |
| 팀원6 | 수중펌프 급수 시스템과 슬라이드판 배식 시스템, 급수/급식기 디자인 |
| 팀원7 | 데이터 자료 수집 |

### 식물
| 이름 | 담당 업무 |
|------|----------|
| 팀원8 | 아두이노 기반 토양 수분 센서와 자동 급수 펌프를 이용한 식물 관리 시스템 개발 |
| 팀원9 | 아두이노 기반 조도 센서 구현 |
